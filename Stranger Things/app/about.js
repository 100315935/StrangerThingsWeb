                ...
                function recogeDatos(oEvent) {
                    ...
                    oDatos.Nombre = document.getElementById("Nombre").value;
                    oDatos.Apellidos = document.getElementById("Apellidos").value;
                    ...
                    oDatos["Quieres recibir noticias sobre otras series"] = "";
                    for (var i = 0; i < aJoomla.length; i++) {
                        if (aJoomla[i].checked) {
                            oDatos["Quieres recibir noticias sobre otras series"] = aJoomla[i].value.toUpperCase();
                        }
                    }
                    //checkbox
                    ...
                    oDatos["En caso de SÍ, ¿sobre cual de las siguientes?"] = sOpcion.text;
                ...
                function main1() {
                    ...
                    if (Modernizr.input.required) {
                       ...
                       //  document.getElementById("Clave2").addEventListener("input", validaPassw )
                    } else {
